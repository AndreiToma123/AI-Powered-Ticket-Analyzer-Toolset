const Dashboard = ({ tickets }: { tickets: any[] }) => {
    const pendingTickets = tickets.filter(t => t.status === 'Available').length;
    const inProgressTickets = tickets.filter(t => t.status === 'In Progress').length;

    return (
        <div className="flex gap-8 mb-8"> 
            
            <div className="flex-1 bg-[#2d3436] text-white px-8 py-6 rounded-lg flex items-center justify-between">
                <div>
            ...
            <div className="flex-1 bg-white text-[#2d3436] border border-[#dfe6e9] px-8 py-6 rounded-lg flex items-center justify-between">
                <div>
